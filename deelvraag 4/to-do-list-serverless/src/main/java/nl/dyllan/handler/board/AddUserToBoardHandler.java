...
import nl.dyllan.handler.board.dto.AddUserToBoardDto;

import java.util.UUID;

@Named("addUserToBoard")
public class AddUserToBoardHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
