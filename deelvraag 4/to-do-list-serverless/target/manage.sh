...
FUNCTION_NAME=ToDoListServerless
HANDLER=io.quarkus.amazon.lambda.runtime.QuarkusStreamHandler::handleRequest
RUNTIME=java17
ZIP_FILE=fileb:///C:/Users/Dylla/OneDrive/Bureaublad/afstuderen/code/migratie-spring-boot-rest/to-do-list-serverless/target/function.zip
...
then
  RUNTIME=provided
  ZIP_FILE=fileb:///C:/Users/Dylla/OneDrive/Bureaublad/afstuderen/code/migratie-spring-boot-rest/to-do-list-serverless/target/function.zip
  FUNCTION_NAME=ToDoListServerlessNative
